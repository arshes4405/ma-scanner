...
const CONFIG = {
  ...
  EXCLUDE_SYMBOLS:    [
    "PLAYUSDT", "RAVEUSDT", "MEGAUSDT", "QNTUSDT", "XVSUSDT", "WLDUSDT", "BRUSDT", "MERLUSDT", "EVAAUSDT", "ARIAUSDT", "BASEDUSDT",
    "STXUSDT", "MANAUSDT", "XLMUSDT", "COMPUSDT", "HBARUSDT", "WOOUSDT", "ICPUSDT", "ACHUSDT", "TUSDT",
    "DUSKUSDT", "IOSTUSDT", "ALGOUSDT", "FLOWUSDT", "FETUSDT", "HIGHUSDT", "BELUSDT", "GTCUSDT",
  ],
